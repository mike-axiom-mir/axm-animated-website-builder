...
const canvas=document.querySelector('#world'),ctx=canvas.getContext('2d'),page=document.querySelector('#page');let w=0,h=0,dpr=1,t=0,playing=false,keys={},activeScene='hero',previous=performance.now(),playerX=0,playerY=0;
